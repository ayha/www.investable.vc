...
$dbase = 'investable_live_modx';
$table_prefix = 'modx_';
$database_dsn = 'mysql:host=localhost;dbname=investable_live_modx;charset=utf8';
...
$site_sessionname = 'SN543b6c0e6f7d6';
$https_port = '443';
...
if (!defined('MODX_HTTP_HOST')) {
    if(defined('PHP_SAPI') && (PHP_SAPI == "cli" || PHP_SAPI == "embed")) {
        ...
        $http_host= array_key_exists('HTTP_HOST', $_SERVER) ? $_SERVER['HTTP_HOST'] : 'www.investable.vc';
