...
if(is_object($result)){
   ...
   if(empty($ids)){
    ...
    //$orders = '{"unpub_date": "ASC", "publishedon":"DESC","menuindex":"ASC"}';
   $orders = '{"menuindex":"ASC"}';
   $params = Array("resources"=>$ids, "tpl"=>"startup_list_chunk", "sortby"=>$orders, "limit"=>"1000", "depth"=>0, "showHidden"=>0, "includeTVs"=>1, "processTVs"=>1, "showUnpublished"=>0);
